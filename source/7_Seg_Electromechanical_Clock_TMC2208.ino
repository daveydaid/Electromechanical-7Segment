...
#include "pin_config.h"             // Contains pin defines for Mega2560
#include <math.h>
...
/*#####################################################################################################
# Function:     whiteTwoButtonISR
#
# Inputs:       n/a
#
# Retuns:       n/a
#####################################################################################################*/
void whiteTwoButtonISR(){
  long debouncing_time = 100; //Debouncing Time in Milliseconds
  static unsigned long last_micros = 0;
...
void dettachAllInterrupts(){
  ...
  detachInterrupt(digitalPinToInterrupt(WHITE_BUTTON_2));  
...
void REattachAllInterrupts(){
  ...
  attachInterrupt(digitalPinToInterrupt(WHITE_BUTTON_2), whiteTwoButtonISR, LOW);    
